  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 right-1/4 w-96 h-96 rounded-full bg-brand-blue/5 blur-3xl" />
        <div className="absolute bottom-1/3 left-1/4 w-96 h-96 rounded-full bg-brand-green/5 blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-md relative animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-100">
            Join <span className="text-gradient-green">LearnPath AI</span>
          </h1>
        ...
        <div className="card p-6 lg:p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="flex items-start gap-2 cursor-pointer pt-1">
              <input type="checkbox" className="w-3.5 h-3.5 rounded border-slate-600 bg-slate-700 accent-brand-green mt-0.5" />
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 py-2.5 rounded-xl border border-slate-600 text-slate-300 text-sm hover:bg-slate-700/40 transition-colors">
